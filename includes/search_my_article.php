    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($categoryInfo) {
                ...
                echo "<div class='lg:h-20 md:h-14 flex justify-center' style='backdrop-filter: blur(10px);'>";
                echo "<button>
                ...
                echo "<button>
                      <a href='#_' class='relative rounded  px-5 ml-5  py-2.5 overflow-hidden group bg-red-500 hover:bg-gradient-to-r hover:from-bg-red-500 hover:to-bg-red-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-400 transition-all ease-out duration-300'>
                        <span class='absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease'></span>
                ...
                echo "<a class='text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0'>Learn More";
