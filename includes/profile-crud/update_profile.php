...
if (isset($_SESSION["user_id"])) {
    ...
    $Update_sql = "UPDATE User SET user_name =?, user_phone=? ,user_email=? ,user_picture=? WHERE id_user=?";
    $stmt = mysqli_prepare($conn, $Update_sql);
    mysqli_stmt_bind_param($stmt, "sissi", $username, $userphone, $useremail, $new_picture, $userId);
