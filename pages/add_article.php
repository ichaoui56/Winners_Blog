                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="col-span-full">
                            <label for="article_title" class="block text-sm font-medium leading-6 text-gray-900">Article
                                Title</label>
                            <div class="mt-2">
                                <input type="text" name="article_title" id="article_title" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="col-span-full">
                            <label for="article_description" class="block text-sm font-medium leading-6 text-gray-900">Article
                                Description</label>
                            <div class="mt-2">
                                <input type="text" name="article_description" id="article_description" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                </div>
