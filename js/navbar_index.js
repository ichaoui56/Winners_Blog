    ...
    const navbarHTML = `
     <nav class="relative mx-10 mb-32 rounded-b-2xl px-4 py-4 flex justify-between items-center bg-white">
        ...
        <a href="./pages/login.php"
            class=" relative w-64 h-14 hidden lg:block left-[10%] px-10 py-3 w-48 overflow-hidden font-bold rounded-full group">
            <span
                class="w-32 h-52  rotate-45 translate-x-12 -translate-y-2 absolute top-0 bg-black opacity-[3%]"></span>
            <span
                class="absolute top-0 left-0 w-[330px] h-96 -mt-1 transition-all duration-900 ease-in-out rotate-45 -translate-x-96 -translate-y-24 bg-black opacity-100 group-hover:-translate-x-1"></span>
            <span
                class="relative text-[21px] w-96 px-6  text-left text-blbg-black transition-colors duration-500 ease-in-out group-hover:text-gray-200">Se
                connecter</span>
            ...
            <div class="mt-auto">
                <div class="pt-6">
                    ...
                    <div x-data="{ open: false }" class="bg-white dark:bg-gray-800 w-64  shadow flex justify-center items-center">
                        <div @click="open = !open" class="relative bottom-[250px] left-[50px] border-b-4 rounded-full border-black py-3"
                            :class="{'border-indigo-700 transform transition duration-300 ': open}"
